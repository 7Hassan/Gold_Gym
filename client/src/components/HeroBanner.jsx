...
const HeroBanner = () => {
  ...
  return <Box sx={{ mt: { lg: '212px', xs: '70px' }, ml: { sm: '50px' } }} position="relative" p="20px">
    <Typography color="#FF2625" fontWeight="600" fontSize="26px">Gold Gym</Typography>
    <Typography fontWeight={700} sx={{ fontSize: { lg: '44px', xs: '40px' } }} mb="23px" mt="30px">
      {t('Sweat, Smile And Repeat')}
    </Typography>
    <Typography fontSize="22px" fontFamily="Alegreya" lineHeight="35px">
      {t('Check out the most effective exercises personalized to you')}
    </Typography>
    <Stack>
